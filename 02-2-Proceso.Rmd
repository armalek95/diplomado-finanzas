...
knitr::include_graphics("diagramas/ProcesoProduccion.jpg")
```
...
kbl(mutate(comp, Composicion_E1=Composicion_E1*100), col.names = c("Compuesto", "%"),
...
knitr::include_graphics("Diagramas/geometria_tabletas.jpg")
```
...
knitr::include_graphics("diagramas/geom_1.png")
```
...
knitr::include_graphics("diagramas/geom_2.png")
```
...
knitr::include_graphics("diagramas/geom_3.png")
```
...
knitr::include_graphics("diagramas/geom_4.png")
```
...
knitr::include_graphics("diagramas/geom_5.png")
```
...
knitr::include_graphics("diagramas/geom_6.png")
```
