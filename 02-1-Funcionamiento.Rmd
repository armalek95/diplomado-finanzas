...
kbl(test_df, col.names = gsub("[.]", " ", names(test_df)), 
             caption = 
...
kbl(df, col.names = c("Nivel", "Probabilidad", "NVP"), 
...
kbl(print_base, col.names = gsub("[.]", " ", names(print_base)), 
...
# Mostrar como tabla usando knitr
kbl(base_tib, col.names = gsub("[.]", " ", names(base_tib)), 
...
# Mostrar como tabla usando knitr
kbl(print_var, col.names = gsub("[.]", " ", names(print_var)), 
...
# Mostrar como tabla usando knitr
kbl(print_varc, col.names = gsub("[.]", " ", names(print_varc)), 
...
# Mostrar como tabla usando knitr
kbl(print, col.names = gsub("[_]", " ", names(print)), 
...
# Mostrar como tabla usando knitr
kbl(print, col.names = gsub("[.]", " ", names(print)), 
