...
Podemos observar toda la información relevente a la sesión en la tabla \@ref(tab:platforminfo) y los paquetes utilizados en la tabla 
\@ref(tab:packagesinfo).
...
\*\* fff ¿es correcta esta forma de mencionar de dónde se tomó la ecuación? \*\*
...
** rrr - Agregar ejemplos como el del primer bullet **
