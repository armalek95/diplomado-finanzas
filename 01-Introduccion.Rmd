...
rrr Agregar definición de Medicina Personalizada - Historia - etc..
...
tabletas en el lugar de entrega.

A continuación se muestran los diagramas que muestran dichos modelos de
negocio.
...
(Farmacias /
Hospitales)](Diagramas/TP_Business_Model_2.png){width="90%"}
